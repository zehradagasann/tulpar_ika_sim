...
# TAM İMPLEMENTE: RTAB-Map'i mevcut sensorlerle (RPLidar S2 + RealSense D455
# derinlik akisi) calisir hale getiren launch dosyasi.
#
...
# - Derinlik kamerasinin point cloud'u (/camera/depth/points, gazebo.launch.py
#   ile zaten bridge'leniyor) SLAM grafigine karistirilmiyor; rviz'de ayri bir
#   3D katman olarak eklenip gorsellestirilebilir.
#
...
# (base_footprint->base_link->lidar_link/camera_link) birebir esidir.
