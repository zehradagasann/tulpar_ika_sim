...
**Ayrıca fark edildi**: bu branch'te `worlds/parkur/*.stl` (kukalar/tabelalar/taşlı-çakıllı yol/yan eğim/yol/zemin) ve `meshes/tulpar_yeni.stl` artık Git LFS pointer'ı (132-133 byte) olarak duruyor — tam parkur world'ü (`worlds/sim_world.sdf`, yeni dosya) için hazırlanmış olabilir, henüz incelenmedi.
